...
<head>
    <meta charset="utf-8">
    <title>Tabella presenza invitati</title>
...
<script>
    ...
    .then(data =>{
        ...
        data.forEach(data =>{
            ...
            checkbox.id = data.ID;
            if(data.PRESENZA === 1) checkbox.checked = true;
    ...
    document.addEventListener("DOMContentLoaded", function(){
        ...
        function contaCheckbox(){
            ...
            if(conteggio>0) risultato.textContent = `N° PRESENTI: ${conteggio}`; 
